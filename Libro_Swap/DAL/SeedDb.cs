    ...
    public static class SeedDb
    {
        public static void Seed(this ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<BookAuthor>().HasData(
                    ...
                    new BookAuthor() { Id = 1, AuthorName = "Софія", AuthorSurname = "Андрухович" },
                    new BookAuthor() { Id = 2, AuthorName = "Оксана", AuthorSurname = "Забужко" },
                    new BookAuthor() { Id = 3, AuthorName = "Луїза", AuthorSurname = "Хей" },
                    new BookAuthor() { Id = 4, AuthorName = "Вадим", AuthorSurname = "Зеланд" },
                    new BookAuthor() { Id = 5, AuthorName = "Джоан", AuthorSurname = "Роулінг" }
                );
            ...
            modelBuilder.Entity<Libro_SwapUser>().HasData(
                
                    new Libro_SwapUser() { Id = 1, UserName = "Cardify", Email = "mbeecker8@deviantart.com", CityId = 4, AboutMe = "Mauris sit amet eros. Suspendisse accumsan tortor quis turpis. Sed ante. Vivamus tortor." },
                    new Libro_SwapUser() { Id = 2, UserName = "Voyatouch", Email = "ktolmanm@php.net", CityId = 3, AboutMe = "Pellentesque ultrices mattis odio. Donec vitae nisi." },
                    new Libro_SwapUser() { Id = 3, UserName = "Konklab", Email = "tcothey1t@gmpg.org", AboutMe = "Nullam molestie nibh in lectus. Pellentesque at nulla. Suspendisse potenti." },
                    new Libro_SwapUser() { Id = 4, UserName = "Ronstring", Email = "jmundow1y@sfgate.com", CityId = 2, AboutMe = "Nulla ut erat id mauris vulputate elementum. Nullam varius. Nulla facilisi. Cras non velit nec nisi vulputate nonummy. Maecenas tincidunt lacus at velit." },
                    new Libro_SwapUser() { Id = 5, UserName = "Flowdesk", Email = "tshimman1a@wp.com", CityId = 1, AboutMe = "In blandit ultrices enim. Lorem ipsum dolor sit amet, consectetuer adipiscing elit." }
                );
